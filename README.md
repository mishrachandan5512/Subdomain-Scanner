...
[![Platform](https://img.shields.io/badge/Platform-Linux%20%7C%20Termux%20%7C%20Windows-red?style=for-the-badge)](https://github.com/mishrachandan5512)
...
The scanner leverages **multi-threading** to simultaneously query multiple intelligence sources including Certificate Transparency logs (crt.sh), HackerTarget, and AlienVault OTX. Optimized for both **Android (Termux)** and **Linux** environments, it provides security researchers with a fast and efficient method to map an organization's complete attack surface.
